...
const PILLARS = [
  {
    ...
    title: { fr: 'Ponctualité garantie', en: 'Punctuality guaranteed', ru: 'Гарантия пунктуальности' },
    desc: {
  ...
  },
  {
    ...
    title: { fr: 'Discrétion absolue', en: 'Absolute discretion', ru: 'Полная конфиденциальность' },
    desc: {
  ...
  },
  {
    ...
    title: { fr: 'Excellence & Luxe', en: 'Excellence & Luxury', ru: 'Превосходство и роскошь' },
    desc: {
  ...
  },
  {
    ...
    title: { fr: 'Tarifs transparents', en: 'Transparent pricing', ru: 'Прозрачные тарифы' },
    desc: {
